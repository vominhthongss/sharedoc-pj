...
function DocumentList(props) {
  ...
  const [changePage, setchangePage] = useState(props.changePage);
  return (
    <div className="p-5">
      {documents.length !== 0 ? (
        ...
        <div className="text-center text-gray-400 text-2xl h-[500px] flex justify-center items-center w-full border">
          <div role="status">
            <svg
              aria-hidden="true"
